...
save(list = "essential_df",
     file = file.path(general_RData_directory, "22) Compile data on essential genes - essential_df.RData")
     )
...
save(list = c("essential_datasets_list", "achilles_depend_df",
     ...
     file = file.path(general_RData_directory, "22) Compile data on essential genes - dependencies data.RData")
     )
