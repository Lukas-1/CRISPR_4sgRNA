...
load(file.path(CRISPRko_RData_directory, "02) Map CRISPRko sgRNA sequences to the rat genome - all_sequences_df.RData"))
load(file.path(CRISPRko_RData_directory, "02) Map CRISPRko sgRNA sequences to the rat genome - genome_search_df.RData"))
...
extended_CRISPRko_df <- FindBest0MMLocations(extended_CRISPRko_df, rat_genes_rn6_GRanges)
