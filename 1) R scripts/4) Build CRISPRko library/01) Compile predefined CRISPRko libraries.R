...
identical(sort(Brunello_df[, "sgRNA Target Sequence"]),
          sort(Brunello_2018_df[!(are_controls_Brunello), "sgRNA Sequence"])
          )
...
Brunello_symbols_noNA <- Brunello_df[!(is.na(Brunello_matches)), "Target Gene Symbol"]
...
Brunello_controls_df <- data.frame(
  ...
  "Exon_number_TKOv3"      = NA_integer_,
  "Exon_number_GPP"        = NA_integer_,
  "sgRNA_sequence"         = Brunello_2018_df[are_controls_Brunello, "sgRNA Sequence"],
