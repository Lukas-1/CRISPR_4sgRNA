...
SNP_column_names <- c("sgRNA_SNP_IDs_vcf",     "sgRNA_SNP_AFs_1kGenomes", "sgRNA_SNP_AF_max_1kGenomes", "sgRNA_SNP_AF_sum_1kGenomes",
                      ...
                      "all23_SNP_IDs_vcf",     "all23_SNP_AFs_1kGenomes", "all23_SNP_AF_max_1kGenomes", "all22_SNP_AF_max_1kGenomes", "all23_SNP_AF_sum_1kGenomes",
                      "all23_SNP_AFs_TOPMED",  "all23_SNP_AF_max_TOPMED", "all22_SNP_AF_max_TOPMED",    "all23_SNP_AF_sum_TOPMED",
                      "all23_SNP_AFs_Kaviar",  "all23_SNP_AF_max_Kaviar", "all22_SNP_AF_max_Kaviar",    "all23_SNP_AF_sum_Kaviar",
                      "all23_SNP_IDs_1kG_ph1", "all23_SNP_AFs_1kG_ph1",   "all23_SNP_AF_max_1kG_ph1",   "all22_SNP_AF_max_1kG_ph1", "all23_SNP_AF_sum_1kG_ph1",
                      "all23_SNP_IDs_1kG_ph3", "all23_SNP_AFs_1kG_ph3",   "all23_SNP_AF_max_1kG_ph3",   "all22_SNP_AF_max_1kG_ph3", "all23_SNP_AF_sum_1kG_ph3",
                      "all23_SNP_IDs_gnomAD",  "all23_SNP_AFs_gnomAD",    "all23_SNP_AF_max_gnomAD",    "all22_SNP_AF_max_gnomAD",  "all23_SNP_AF_sum_gnomAD"
                      )

SNP_columns <- SNP_column_names[SNP_column_names %in% colnames(merged_replaced_CRISPRa_df)]
