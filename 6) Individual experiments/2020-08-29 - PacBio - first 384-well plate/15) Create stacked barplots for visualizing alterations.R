...
for (smrtlink_version in c(7, 9)) {
  ...
  for (reorder_wells in c(FALSE, TRUE)) {
    ...
    DrawAlterationBarplot(ccs5_df_list[["original_summary_df"]],
                          main_title = ccs5_title, reorder_wells = reorder_wells
                          )
    DrawAlterationBarplot(ccs5_df_list[["filtered_summary_df"]],
                          main_title = ccs5_title, reorder_wells = reorder_wells
                          )
    DrawAlterationBarplot(ccs5_df_list[["filtered_gRNAs_df"]],
                          main_title = ccs5_title, reorder_wells = reorder_wells
                          )

    DrawAlterationBarplot(ccs3_df_list[["original_summary_df"]],
                          main_title = ccs3_title, reorder_wells = reorder_wells
                          )
    DrawAlterationBarplot(ccs3_df_list[["filtered_summary_df"]],
                          main_title = ccs3_title, reorder_wells = reorder_wells
                          )
    DrawAlterationBarplot(ccs3_df_list[["filtered_gRNAs_df"]],
                          main_title = ccs3_title, reorder_wells = reorder_wells
                          )
