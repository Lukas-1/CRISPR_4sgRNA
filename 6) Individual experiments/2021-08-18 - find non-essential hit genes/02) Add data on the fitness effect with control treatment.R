...
baseline_genes_df <- data.frame(
  ...
  "Mean_FC_essential"   = tapply(baseline_df[["log2 Ratio"]], genes_fac, mean),
  "Num_essential_gRNAs" = tapply(baseline_df[["Pass_threshold"]], genes_fac, sum),
  "Min_FC_essential"    = tapply(baseline_df[["log2 Ratio"]], genes_fac, min),
...
NA_empty_columns <- c("CRISPR_mean_probability",   "CRISPR_num_essential",   "CRISPR_num_cell_lines",
                      ...
                      "Expressed_in_GT17",
                      "Num_essential_gRNAs", "Mean_FC_essential",
                      "Min_FC_essential", "Min_FDR_essential"
                      )
