...
## 99.3% of paired-end reads contained at least one sgRNA sequence
...
## 96.0% of paired-end reads contained two sgRNA sequences from the library.
## (In relative terms, 96.7% of just those reads that contained one sgRNA from
...
## 26.5% of reads (with two sgRNA sequences that are found in the library)
