...
run1_rdata_path <- file.path(first_illumina_trial_dir, "03_R_objects", "01_read_in_data_run1.RData")
...
save(run1_matched_df,
     file = file.path(rdata_dir, "04_look_up_sgRNAs_run1.RData")
     )
