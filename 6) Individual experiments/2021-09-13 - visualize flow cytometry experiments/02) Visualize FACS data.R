...
FACSViolinBox <- function(input_df, use_target, use_brewer = "Blues") {

  sub_df <- PrepareFACSData(input_df, use_target)

  DrawViolinBox(sub_df[, "Biexp_data"],
                sub_df[, "Group"],
...
FACSViolinBox(BFP_df, "CD2",   "Blues")
FACSViolinBox(BFP_df, "CD4",   "Purples")
FACSViolinBox(BFP_df, "CD43",  "Greens")
FACSViolinBox(BFP_df, "CD200", "Greys")
