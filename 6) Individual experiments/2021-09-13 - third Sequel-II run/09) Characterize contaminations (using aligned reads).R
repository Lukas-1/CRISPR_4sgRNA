...
output_directory         <- file.path(s2r3_directory, "5) Output", "Tables", "Aligned contaminations")
...
save(list = "contam_df",
     file = file.path(s2r3_R_objects_directory, "09) Characterize contaminations (using aligned reads).RData")
     )
