...
sl7_ccs7_lima_zmws <- GetCCS7ZMWs(sl7_ccs_df, wells_vec = sg_sequences_df[["Well_number"]])
sl9_ccs7_lima_zmws <- GetCCS7ZMWs(sl9_ccs_df, wells_vec = sg_sequences_df[["Well_number"]])
