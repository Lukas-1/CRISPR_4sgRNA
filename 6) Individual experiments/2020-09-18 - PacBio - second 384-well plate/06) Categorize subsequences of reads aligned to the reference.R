...
sl7_extracted_df <- ExtractAlignedSequences(sl7_ccs_df, sl7_alignments_df, wells_vec = sg_sequences_df[["Well_number"]])
sl9_extracted_df <- ExtractAlignedSequences(sl9_ccs_df, sl9_alignments_df, wells_vec = sg_sequences_df[["Well_number"]])
