...
# sl7_CCS3_lima_bam_file    <- file.path(raw_data_directory, "SmrtLink7_CCS3/lima", "lukaslimaCCS3SL7output.bam")
sl7_CCS5_lima_bam_file    <- file.path(raw_data_directory, "SmrtLink7_CCS5/lima", "lukaslimaCCS5SL7output.bam")
# sl9_CCS3_lima_bam_file    <- file.path(raw_data_directory, "SmrtLink9_CCS3/lima", "lukas_lima_CS3_SL9.bam")
# sl9_CCS5_lima_bam_file    <- file.path(raw_data_directory, "SmrtLink9_CCS5/lima", "lukas_lima_CS5_SL9.bam")

# sl7_CCS3_lima_report_file <- file.path(raw_data_directory, "SmrtLink7_CCS3/lima", "lukaslimaCCS3SL7output.lima.report")
sl7_CCS5_lima_report_file <- file.path(raw_data_directory, "SmrtLink7_CCS5/lima", "lukaslimaCCS5SL7output.lima.report")
# sl9_CCS3_lima_report_file <- file.path(raw_data_directory, "SmrtLink9_CCS3/lima", "lukas_lima_CS3_SL9.lima.report")
# sl9_CCS5_lima_report_file <- file.path(raw_data_directory, "SmrtLink9_CCS5/lima", "lukas_lima_CS5_SL9.lima.report")
...
ccs5_combos <- paste0("sl", c(7), "_ccs5_")
