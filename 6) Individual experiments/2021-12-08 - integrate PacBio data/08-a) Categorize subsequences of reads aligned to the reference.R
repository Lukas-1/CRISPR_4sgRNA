...
load(file.path(s2rI_R_objects_directory, "07.5) Pre-filter reads - alignments_df.RData"))
...
save(list = c("extracted_df",
     ...
     file = file.path(s2rI_R_objects_directory, "08-a) Categorize subsequences of reads aligned to the reference.RData")
     )
