...
deletions_df <- CompileDeletions(alignments_df, "Combined_ID", sg_sequences_df[["Combined_ID"]])
...
save(list = "deletions_df",
     file = file.path(sql2_R_objects_directory, "19) Identify and characterize large deletions.RData")
     )
