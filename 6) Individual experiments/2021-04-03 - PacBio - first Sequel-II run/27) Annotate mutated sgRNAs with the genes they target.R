...
tables_directory         <- file.path(sql2_directory, "5) Output", "Tables",  "Targets of mutated gRNAs")
figures_directory        <- file.path(sql2_directory, "5) Output", "Figures", "Targets of mutated gRNAs")
