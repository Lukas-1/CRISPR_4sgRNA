...
output_directory         <- file.path(s2r4_directory, "5) Output", "Tables", "Aligned contaminations")
...
contam_df[grepl("Plate094", contam_df[, "Reference_ID"], fixed = TRUE), ]
...
save(list = "contam_df",
     file = file.path(s2r4_R_objects_directory, "19) Check for cross-plate contaminations.RData")
     )
